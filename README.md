...
把零售增长、数据报表、客户经营、AI 落地这几件事，沉淀成可复用的方法论与体系。每一篇都按同一结构组织：先给一句话框架与适用边界，再展开原理、步骤、案例与可复用产物。

## 体系 / 系统（可预览）

| 系统 | 预览链接 | 说明 |
| --- | --- | --- |
| AI 销售助理 | https://yanyangjiayou.github.io/ai-sales-assistant/ | 面向零售销售场景的 AI 辅助工作台原型 |
| 培训报表洞察自动化 | https://yanyangjiayou.github.io/training-report-insight/ | 数据从接入到报表与洞察的自动化演示 |
| 向光工作台 | https://yanyangjiayou.github.io/xiangguang-workbench/ | 个人管理系统（驾驶舱 / 待办 / 证据墙 / 反馈记录） |
...
| 想用 AI 却不敢动？用「黄金四原则」找到第一个见效的场景 | 高频×高效×低复杂×可评估，选出第一刀 | https://github.com/yanyangjiayou/ai-sales-system/blob/main/文章/想用AI却不敢动-用黄金四原则找到第一个见效场景.md |
